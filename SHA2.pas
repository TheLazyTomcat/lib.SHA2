...
Function CreateFromByLength(SHA2: TSHA2): TSHA2Hash; overload;{$IFDEF CanInline} inline; {$ENDIF}
...
Function CreateFromByLength(SHA2: TSHA2): TSHA2Hash;
begin
Result := CreateFromByLength(SHA2.HashLength,SHA2);
end;
